   export function contactSuccessMail(kurse: string) {
    return {
      htmlContentMsg: `
      ...
      <div style=" padding:20px; background-color:#f5eee6; border-style:solid; border-width:0px;border-radius: 10px;">
        ...
        <p style="font-family:sans-serif;color:rgb(0, 0, 0); margin: 20px"> Has consultado por disponibilidad de cupos en el curso ${kurse}.</p>
